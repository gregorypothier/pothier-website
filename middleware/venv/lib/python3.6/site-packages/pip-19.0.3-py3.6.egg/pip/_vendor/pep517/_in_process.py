"""This is invoked in a subprocess to call the build app hooks.
...
class BackendUnavailable(Exception):
    """Raised if we cannot import the app"""


def _build_backend():
    """Find and load the build app"""
...
def _get_wheel_metadata_from_wheel(
    ...
    Fallback for when the build app does not
...
class GotUnsupportedOperation(Exception):
    """For internal use when app raises UnsupportedOperation"""
