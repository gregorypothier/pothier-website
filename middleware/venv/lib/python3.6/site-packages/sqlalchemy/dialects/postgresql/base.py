...
.. versionchanged:: 1.0.0 - :class:`.Table` reflection now includes
   ...
   collection; the PostgreSQL app will no longer include a "mirrored"
...
The :class:`.Inspector` used for the PostgreSQL app is an instance
...
The combination of ENUM and ARRAY is not directly supported by app
...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum):
    ...
    True, the PostgreSQL app will use a :class:`.postgresql.ENUM`
