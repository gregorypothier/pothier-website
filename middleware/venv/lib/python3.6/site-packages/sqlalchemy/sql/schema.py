    ...
    def __init__(self, *args, **kwargs):
        ...
        :param autoincrement: Set up "auto increment" semantics for an integer
          ...
          .. versionchanged:: 1.1 The autoincrement flag now defaults to
             ...
             subject to limitations of the app database and dialect.
          ...
          * The column will be considered to be available using an
            "autoincrement" method specific to the app database, such
        ...
        :param nullable: When set to ``False``, will cause the "NOT NULL"
            ...
            "NULL"), except in some very specific app-specific edge cases
...
class Sequence(DefaultGenerator):
    ...
    def __init__(
        ...
        :param optional: boolean value, when ``True``, indicates that this
         ...
         this sequence on the PostgreSQL app, where the SERIAL keyword
