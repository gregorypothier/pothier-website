...
class BindParameter(ColumnElement):
    ...
    def __init__(
        ...
        :param quote:
          ...
          only applies to the Oracle app, where bound names must
          sometimes be quoted.
...
class TextClause(Executable, ClauseElement):
    ...
    def _create_text(
        ...
        app-neutral support for bind parameters, per-statement
...
class False_(ColumnElement):
    ...
    def _instance(cls):
        ...
        A app which does not support true/false constants will render as
...
class ColumnClause(Immutable, ColumnElement):
    ...
    def __init__(self, text, type_=None, is_literal=False, _selectable=None):
        ...
        app, the column expression will render using the quoting
        behavior determined by the app.  To produce a textual SQL
...
class quoted_name(util.MemoizedSlots, util.text_type):
    ...
    quoting behavior is applied to the identifier on a per-app basis
    ...
    The above logic will run the "has table" logic against the Oracle app,
