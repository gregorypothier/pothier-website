...
class UpdateBase(
    ...
    def with_hint(self, text, selectable=None, dialect_name="*"):
        ...
        hint to a particular app. Such as, to add a hint
...
class ValuesBase(UpdateBase):
    ...
    def return_defaults(self, *cols):
        ...
        When used against a app that supports RETURNING, all column
        ...
        3. It can be called against any app.  Backends that don't support
