...
class InstallRequirement(object):
    ...
    def __init__(
        ...
        # gets stored. We need this to pass to build_wheel, so the app
        ...
        # The PEP 517 app we should use to build the project
    ...
    def prepare_metadata(self):
        ...
        Under PEP 517, call the app hook to prepare the metadata.
