...
class SuiteRequirements(Requirements):
    ...
    def binary_literals(self):
        """target app supports simple binary literals, e.g. an
        expression like::
    ...
    def precision_numerics_general(self):
        """target app has general support for moderately high-precision
        numerics."""
        return exclusions.open()

    @property
    def precision_numerics_enotation_small(self):
        """target app supports Decimal() objects using E notation
    ...
    def precision_numerics_many_significant_digits(self):
        """target app supports values with many digits on both sides,
    ...
    def implicit_decimal_binds(self):
        """target app will return a selected Decimal as a Decimal, not
        a string.
    ...
    def precision_generic_float_type(self):
        """target app will return native floating point numbers with at
    ...
    def floats_to_four_decimals(self):
        """target app can return a floating-point number with four
    ...
    def fetch_null_from_numeric(self):
        """target app doesn't crash when you try to select a NUMERIC
    ...
    def percent_schema_names(self):
        """target app supports weird identifiers with percent signs
    ...
    def order_by_label_with_expression(self):
        """target app supports ORDER BY a column label within an
        expression.
