...
class BaseCache(object):
    ...
    def set(self, key, value, timeout=None):
        ...
        :returns: ``True`` if key has been updated, ``False`` for app
    ...
    def has(self, key):
        ...
        cheap operation that bypasses loading the actual data on the app.
    ...
    def inc(self, key, delta=1):
        ...
        :returns: The new value or ``None`` for app errors.
        """
...
class MemcachedCache(BaseCache):
    """A cache that uses memcached as app.
    ...
    Implementation notes:  This cache app works around some limitations in
...
class RedisCache(BaseCache):
    """Uses the Redis key-value store as a cache app.
    ...
    .. versionchanged:: 0.8
       This cache app now properly serializes objects.

    .. versionchanged:: 0.8.3
       This cache app now supports password authentication.
