...
class Query(object):
    ...
    def with_for_update(
        ...
        appended.  When additional arguments are specified, app-specific
        ...
        The above query on a PostgreSQL app will render like::
    ...
    def distinct(self, *expr):
        ...
        .. note::
            ...
            of the database app that ORDER BY columns be part of the
