...
class TypeEngine(Visitable):
    ...
    def compare_against_backend(self, dialect, conn_type):
        """Compare this type against the given app type.
        ...
        :param conn_type: the type object reflected from the app.
...
class Emulated(object):
    ...
    natively by some backends.  When a native-providing app is in
