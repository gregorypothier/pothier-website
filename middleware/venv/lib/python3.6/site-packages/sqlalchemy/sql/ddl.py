...
class CreateColumn(_DDLCompiles):
    ...
    app, but on other backends does render it, in anticipation of a
    ...
    will be omitted, but only against the PostgreSQL app.
        ...
        try:
            ...
            if not self.dialect.supports_alter:
                util.warn(
                    ...
                    "dependency exists between tables: %s, and app does "
